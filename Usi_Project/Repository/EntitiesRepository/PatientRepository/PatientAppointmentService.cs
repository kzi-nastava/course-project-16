...
namespace Usi_Project.Repository
{
    public class PatientAppointmentService
    {
        ...
        public static void CreateAppointment(Patient patient, Doctor doctorForAppoint=null)
        {
            string appType;
        ...
        public static void AutoAppointment(Patient patient, Doctor doctorForAppoint=null)
        {
            if (doctorForAppoint is null)
                doctorForAppoint = ResolveAppointmentDataService.ResolveDoctorForAppointment(2);
            ...
            DateTime appointTime = ResolveAppointmentDataService.AutoTimeForAppointment(doctorForAppoint, timeDelta);
            ...
            string roomId = ResolveAppointmentDataService.ResolveRoomForAppointment(appointTime);
             ...
             PatientManager._factory.AppointmentManager.Appointment.Add(appointment);
             PatientManager._factory.Saver.SaveAppointment(appointments);
